...
const perks = [
  { icon: '🎋', title: '免費包粽體驗', desc: '全程材料、工具提供，從零開始學會手作粽子，帶一顆親手包的粽子回家。' },
  { icon: '🍜', title: '夜市美食吃到飽', desc: '活動當晚，所有夜市攤位免費暢吃。夜市靈魂在於——吃飽才有力氣包粽。' },
  { icon: '📸', title: '夢幻場景拍照', desc: '燈串、蒸氣、復古場景設計，讓你的每一張照片都是IG爆讚的質感大片。' },
  { icon: '🤝', title: '認識新朋友', desc: '和一群對生活有熱情的人一起，在揉米、包葉之間，展開一段新的友誼。' },
  { icon: '🏅', title: '包粽達人認證', desc: '活動結束後，獲得專屬「粽夏夜包粽夥伴」限定証書與紀念小物。' },
  { icon: '🌙', title: '端午夜市夢幻夜', desc: '不只是活動，是一個你會想在記憶裡收藏的夜晚。光是來了，就值得了。' },
];
    ...
    <section className="recruit" id="recruit">
      ...
      <div className="recruit-container">
        <div className="recruit-header fade-up">
          <div className="section-label">✦ Join The Dream</div>
          ...
          <div className="rhc-content">
            <div className="rhc-left">
              ...
              <ul className="rhc-checklist">
                <li>✓ 活動日期：2025 年 6 月 29 日（端午節前夕）</li>
                <li>✓ 活動時間：下午 4 點 — 晚上 10 點</li>
                <li>✓ 報名截止：額滿為止</li>
                <li>✓ 報名費用：免費（限量開放）</li>
              </ul>
              <div className="rhc-cta-group">
                <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="btn-primary pulse-btn rhc-cta">
                  🎋 立即報名包粽夥伴
                </a>
                <div className="rhc-urgency">⚡ 已有 <strong>47</strong> 位夥伴報名</div>
              </div>
            </div>
        ...
        <div className="perks-grid">
          {perks.map((p, i) => (
            <div key={i} className={`perk-card fade-up delay-${(i % 3) + 1}`}>
        ...
        <div className="recruit-bottom-cta fade-up">
          ...
          <a href={FORM_URL} target="_blank" rel="noopener noreferrer" className="btn-primary pulse-btn" style={{ fontSize: '1.1rem', padding: '1rem 2.8rem' }}>
            加入粽夏夜 ✦
          </a>
        </div>
      </div>
